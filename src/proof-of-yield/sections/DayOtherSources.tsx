  ...
  return (
    <Section className={twMerge("", sectionOverrideCss)}>
      <Table className="mt-8">
        <thead>
          <tr>
            <TableHead align="left" className="pl-8 w-auto">
              Other Sources
            </TableHead>
            <TableHead info={true} className="pr-6 whitespace-normal">
              Yield / % of total
            </TableHead>
            <TableHead className="pr-8 whitespace-normal">
              More details
            </TableHead>
          </tr>
        </thead>
