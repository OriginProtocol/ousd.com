...
const YieldBoostMultiplier = () => {
  return (
    <div className="w-full lg:w-1/3 h-min rounded-lg bg-origin-bg-grey text-blurry">
      <div className="flex justify-center items-center w-fit m-8 pt-8 lg:pt-0">
      ...
      <div className="border-2 mx-8 border-origin-bg-black px-6 py-4 mt-6 rounded-t-lg flex flex-col 2xl:flex-row 2xl:justify-between 2xl:items-center">
        <div>
      ...
      <div className="border-2 mx-8 border-t-0 border-origin-bg-black px-6 py-4 flex flex-col 2xl:flex-row 2xl:justify-between 2xl:items-center">
        <div>
      ...
      <div className="mt-8 flex flex-col xl:flex-row border-t-2 border-origin-bg-black">
        <div className="w-full xl:w-1/2 py-6 px-6 border-b-2 xl:border-b-0 xl:border-r-2 border-origin-bg-black">
          <TitleWithInfo textClassName="text-sm">
            Non-Rebasing supply
          </TitleWithInfo>
