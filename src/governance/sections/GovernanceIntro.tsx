  ...
  return (
    ...
    >
      ...
      <Typography.Body2 className="mt-8 md:mt-10 lg:max-w-[90%] xl:max-w-[60%] relative z-10 px-6 lg:px-20">
        Origin Dollar and Origin Ether consist of a set of automated smart contracts on the Ethereum blockchain. This code, protected by a 48-hour timelock, is owned and controlled by a global community of OGV token holders who operate a decentralized autonomous organization, known as the Origin DeFi DAO.
      </Typography.Body2>
