    ...
    <>
      <section className="gradient3 relative z-0">
        <div className="relative divide-black divide-y-2">
          <div>
            <div className="flex flex-col lg:flex-row overflow-hidden max-w-screen-2xl mx-auto px-[32px] py-[56px] md:px-[64px] lg:py-[120px] lg:pl-[134px] lg:pr-[208px] text-center lg:text-left">
