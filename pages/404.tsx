        ...
        <div className='px-8 md:px-16 lg:px-[134px] pb-[136px] md:pb-[294px]'>
          <div className='max-w-[1432px] mx-auto'>
            <div className='mt-5 md:mt-16'>
              <Typography.H2 as='h1' className='text-[36px] leading-[40px] md:text-[72px] md:leading-[84px] text-gradient2' style={{ fontWeight: 700 }}>
                {'Ooops...'}
              </Typography.H2>
            </div>
            ...
            <Link
              href="/"
              className="bttn !mt-10 md:!mt-20 !ml-0 gradient2"
            >
